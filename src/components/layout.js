      ...
      <nav className="bg-indigo-800">
            ...
            <div className="flex items-center">
              ...
              <div className="hidden md:block">
                <div className="ml-10 flex items-baseline space-x-4">
                  <a
                    href="#"
                    className="px-3 py-2 rounded-md text-sm font-medium text-white bg-indigo-900 focus:outline-none focus:text-white focus:bg-indigo-700"
                  >
                    Dashboard
                  </a>
        ...
        >
          <div className="px-2 py-3 space-y-1 sm:px-3">
            <a
              href="#"
              className="block px-3 py-2 rounded-md text-base font-medium text-white bg-indigo-900 focus:outline-none focus:text-white focus:bg-indigo-700"
            >
              Dashboard
            </a>
